<%-- 
    ...
    Created on : Jul 4, 2024, 6:15:28 PM
    Author     : nhat minh
--%>
            ...
            <div class="modal-dialog">
                    <div class="modal-content">
                                    <div class="modal-header">						
                                            ...
                                            <a href="javascript:window.history.back();" class="close" aria-hidden="true">&times;</a>
                                    </div>
                                    <p class="alert-danger">${mess}</p>
                                    <div class="modal-body">	
                                            <div class="form-group">
                                                    <label>ID</label>
                                                    <input readonly value="${product.id}" type="text" class="form-control" name="id" required>
                                            </div>
                                            <div class="form-group">
                                                    <label>NAME</label>
                                            ...
                                            <div class="form-group">
                                                <label>CATEGORY ID</label>
                                                    <input value="${product.cateID}" name="sellid" type="number" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                    <label>SELL ID</label>
                                                    <input value="${product.sell_ID}" name="sellid" type="number" class="form-control" required>
                                            </div>					
                                    </div>
